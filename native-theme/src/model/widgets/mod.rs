...
mod tests {
    ...
    fn button_validate_widget_extracts_all_fields() {
        ...
        let resolved =
            ResolvedButtonTheme::validate_widget(&button, "button", 96.0, &mut missing);
        ...
        assert_eq!(
            resolved.active_background,
            Some(Rgba::rgb(180, 180, 180))
        );
        assert_eq!(
            resolved.disabled_background,
            Some(Rgba::rgb(220, 220, 220))
        );
    }
