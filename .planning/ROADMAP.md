...
**Depends on:** Phase 93
**Plans:** 3/3 plans complete (wave 1: 94-01 + 94-02 parallel; wave 2: 94-03 serial on 94-02's pipeline.rs shape)
...
Plans:
- [x] 95-01-PLAN.md — G9: Add rustdoc on `SystemTheme::name`/`icon_theme` (lib.rs:371/387) documenting Cow<'static, str>→Arc<str> principled deviation + APPEND-ONLY post-scripts to doc 2 §J.2 and §K.3 (wave 1, autonomous, two files: native-theme/src/lib.rs + docs/todo_v0.5.7_native-theme-api-2.md) — COMPLETE at commit 2f3e0e8 (2026-04-20)
- [x] 95-02-PLAN.md — G10: **REVISED SCOPE** — original plan premise was inverted (claimed modern WinUI 3 = primary rightmost; live MS docs `https://learn.microsoft.com/en-us/windows/apps/design/controls/dialogs-and-flyouts/dialogs` ms.date 2025-08-05 say PrimaryButton **leftmost**). Existing docs/platform-facts.md:1481/1501/1803 were ALREADY CORRECT per modern MS guidance. Revised scope: APPEND-ONLY modern WinUI 3 citation row at docs/platform-facts.md:1804 + continuity prose sentence at :1504-1507 + APPEND-ONLY SCOPE REVISION annotation on 95-02-PLAN.md tail + 3 critical out-of-scope flags in SUMMARY (native-theme/src/windows.rs:517 likely code bug assigning PrimaryRight, docs/todo_v0.5.7_gaps.md §G10 premise itself inverted, gaps.md:537 stale :557 line-number) — COMPLETE at commits 2d0a2d5 + 15006f9 + 2304acb (2026-04-20, user-approved scope revision)
- [x] 95-03-PLAN.md — G11: Formalise accepted --workspace → per-crate principled deviation via new `.planning/phases/93-.../93-G11-DEVIATION.md` cross-plan record + APPEND-ONLY annotation blocks on 5 Phase 93 PLAN files (93-01..05) + new "Known upstream tool-chain deviations (v0.5.7+)" section in RELEASING.md (wave 1, autonomous, seven files: 1 new + 6 existing, APPEND-ONLY on existing per user memory rule) — COMPLETE at commit 10028ec (2026-04-20, parallel executor)
