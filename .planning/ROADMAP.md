...
Plans:
- [x] 27-01-PLAN.md — AnimatedIcon/TransformAnimation/Repeat types with TDD, first_frame(), loading_indicator()
- [x] 27-02-PLAN.md — StatusLoading to StatusBusy rename across workspace
...
Plans:
- [x] 29-01-PLAN.md — Sprite sheet parser, two-pass animation loader, and loading_indicator wiring
...
**Plans:** 1/1 plans complete
Plans:
- [x] 30-01-PLAN.md — prefers_reduced_motion() with OnceLock caching and platform-specific backends
...
**Plans:** 1/1 plans complete
Plans:
- [x] 31-01-PLAN.md — AnimatedIcon helpers for gpui (frame conversion + spin wrapper) and iced (SVG handles + rotation radians)
