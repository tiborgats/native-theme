...
- [x] **VERIFY-01**: `pre-release-check.sh` passes after each major phase (schema, resolve, presets, connectors)
...
- [x] **DOC-05**: CHANGELOG updated with all breaking changes and migration notes
