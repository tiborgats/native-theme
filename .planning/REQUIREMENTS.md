...
- [ ] **POLISH-03**: `#[must_use]` convention trimmed to uniform bare `#[must_use]` across the crate — six call sites updated: `pipeline.rs:132`, `pipeline.rs:175`, `model/icons.rs:438`, `model/icons.rs:477`, `lib.rs:353` (`from_system`), `model/mod.rs:225` (`ThemeSpec` struct) (doc 1 §26 + §33 F3)
