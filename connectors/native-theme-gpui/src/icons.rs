...
/// Map a gpui-component icon name string to its canonical Phosphor icon name.
///
/// Returns the kebab-case Phosphor Regular name for use with
/// [`native_theme::bundled_icon_by_name`].
///
/// Covers all 86 gpui-component `IconName` variants.
pub fn phosphor_name_for_gpui_icon(gpui_name: &str) -> Option<&'static str> {
    Some(match gpui_name {
        "ALargeSmall" => "text-aa",
        "ArrowDown" => "arrow-down",
        "ArrowLeft" => "arrow-left",
        ...
        "Delete" => "trash",
        "Ellipsis" => "dots-three",
        "EllipsisVertical" => "dots-three-vertical",
        ...
        "Palette" => "palette",
        "PanelBottom" => "rows",
        "PanelBottomOpen" => "rows",
        "PanelLeft" => "sidebar",
        "PanelLeftClose" => "sidebar",
        "PanelLeftOpen" => "sidebar",
        "PanelRight" => "sidebar",
        "PanelRightClose" => "sidebar",
        ...
        "Replace" => "swap",
        "ResizeCorner" => "dots-six-vertical",
        "Save" => "floppy-disk",
        "Scan" => "scan",
        "Scissors" => "scissors",
        ...
        "User" => "user",
        "WindowClose" => "x",
        "WindowMaximize" => "arrows-out",
        "WindowMinimize" => "minus",
        "WindowRestore" => "arrows-in",
        "X" => "x",
        _ => return None,
    })
}
