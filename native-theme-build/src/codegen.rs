...
pub(crate) fn generate_code(
    ...
    if crate_path == "native_theme" {
        writeln!(out, "extern crate native_theme;").unwrap();
        writeln!(out).unwrap();
    }
    ...
    // IconProvider impl
    writeln!(out, "impl {crate_path}::IconProvider for {enum_name} {{").unwrap();
                        ...
                        MappingValue::DeAware(de_map) => {
                            ...
                            if de_entries.is_empty() {
                                ...
                                writeln!(out, "                #[cfg(not(target_os = \"linux\"))]")
                                    .unwrap();
                                writeln!(out, "                {{").unwrap();
                                writeln!(out, "                    Some(\"{escaped_default}\")")
                                    .unwrap();
                                writeln!(out, "                }}").unwrap();
                                writeln!(out, "            }},").unwrap();
                            }
